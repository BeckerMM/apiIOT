...
const { leiteenvasado, getLeiteenvasado, getDadosDoMiguel, postDadosDoMiguel , getLuka} = require("./src/requisições/temperatura");
...
router.get("/luka", (req,res) => getLuka(res));
